module Sinatra
	module Message
		...
		def is_valid(w)
			words = ['this', 'there', 'their', 'and', 'was', 'has', 'had', 'have', 'but', 'wasnt', 'hasnt', 'would', 'could', 'wouldnt', 'couldnt', 'where', 'here', 'theyre', 'they', 'are', 'theyre', 'the', 'them', 'its', 'hadnt', 'ive', 'were', 'didnt', 'did', 'that', 'what']
